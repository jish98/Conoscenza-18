...
$(window).on('load', function(){
	...
	loadChecker = setInterval(function(){
		if(loadReady){
			...
			TweenMax.to('#loader', .75, {delay:.5, opacity:0, 'display':'none', onComplete:function(){
				unfreezePage();
			}});
			$(window).resize();
...
// 	for(n=0;n<3;n++){
// 		colData += '<div class="column-line" data-num="'+(n+1)+'"><div class="data-line part vert"><img src="images/parts/data-line-vert.svg"></div></div>';
// 	}	
// 	colData += '</div>';
// }
...
for(i=0;i<4;i++){
	colData += '<div class="column-lines" data-num="'+(i+1)+'">';	
	for(n=0;n<3;n++){
		colData += '<div class="column-line" data-num="'+(n+1)+'"><div class="data-line-group part"><div class="data-line part vert"><img src="images/parts/data-line-vert.svg"></div><div class="data-line part vert"><img src="images/parts/data-line-vert.svg"></div><div class="data-line part vert"><img src="images/parts/data-line-vert.svg"></div></div></div>';
	}	
	colData += '</div>';
}
...
for(i=0;i<2;i++){
	colData += '<div class="column-lines" data-num="'+(i+1)+'">';	
	for(n=0;n<3;n++){
		colData += '<div class="column-line" data-num="'+(n+1)+'"><div class="data-line-group part"><div class="data-line part vert"><img src="images/parts/data-line-vert2.svg"></div><div class="data-line part vert"><img src="images/parts/data-line-vert2.svg"></div><div class="data-line part vert"><img src="images/parts/data-line-vert2.svg"></div></div></div>';
	}	
	colData += '</div>';
}
...
// preload images
var img = new Image();
img.src = 'images/slideshow/1_LogIn.jpg';
img.src = 'images/slideshow/2_User-Profile.jpg';
img.src = 'images/slideshow/3_Certificates.jpg';
img.src = 'images/slideshow/4_ScrollingGoods.jpg';
img.src = 'images/slideshow/5_Individual.jpg';
...
for(i=0;i<3;i++){
	...
	for(n=0;n<totCoinDrops;n++){
		token2Coins += '<div class="coin part off" data-num="'+(n+1)+'"><img src="images/parts/token2-coin.svg"></div>';
	}
...
var rmDataLine1 = '<div class="ornament-line" data-num="1"><img src="images/roadmap-ornament-line1.svg"><div class="ornament-line-group"><div class="data-line-wrap horiz" data-num="1"></div><div class="data-line-wrap vert" data-num="2"></div><div class="data-line-wrap horiz" data-num="3"></div></div></div>';
var rmDataLine2 = '<div class="ornament-line" data-num="2"><img src="images/roadmap-ornament-line2.svg"><div class="ornament-line-group"><div class="data-line-wrap horiz" data-num="1"></div><div class="data-line-wrap vert" data-num="2"></div><div class="data-line-wrap horiz" data-num="3"></div></div></div>';
...
$.each(yearMarks, function(i, val){
	$('.tickmark[data-num="'+val+'"]').addClass('year').append('<div class="rm-yeartext sized"><img src="images/'+yearImages[i]+'.svg"></div>');
})
...
vlineData += '<div class="data-line part vert" data-num="1"><img src="images/parts/data-line-vert.svg"></div>';
vlineData += '<div class="data-line part vert" data-num="2"><img src="images/parts/data-line-vert.svg"></div>';
vlineData += '<div class="data-line part vert" data-num="3"><img src="images/parts/data-line-vert.svg"></div>';
vlineData += '<div class="data-line part vert" data-num="4"><img src="images/parts/data-line-vert.svg"></div>';
$('.v-line-anim').html(vlineData);


var dlineDataH = '<div class="data-line part horiz"><img src="images/parts/data-line-horiz.svg"></div><div class="data-line part horiz"><img src="images/parts/data-line-horiz.svg"></div>';
var dlineDataV = '<div class="data-line part vert"><img src="images/parts/data-line-vert.svg"></div><div class="data-line part vert"><img src="images/parts/data-line-vert.svg"></div>';
...
function popMultiData(dir,tot,gap){
	...
	for(n=0;n<2;n++){
		...
		for(i=0;i<tot;i++){
			colData += '<div class="data-line part '+dir+'" style="transform:translate'+axis+'('+(gap*i)+'px);"><img src="images/parts/data-line-'+dir+'.svg"></div>';	
		}
		colData += '</div>';
	}
	return colData;
